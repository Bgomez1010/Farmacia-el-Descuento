			   ...
			   $tabla.='</p>
					...
					<div class="media-content">
						...
						<div class="has-text-right">
							<a href="index.php?vista=promocion_img&promo_id_up='.$rows['promocion_id'].'" class="button is-link is-rounded is-small">Imagen</a>
							<a href="index.php?vista=promocion_update&promo_id_up='.$rows['promocion_id'].'" class="button is-success is-rounded is-small">Actualizar</a>
							<a href="'.$url.$pagina.'&promo_id_del='.$rows['promocion_id'].'" class="button is-danger is-rounded is-small">Eliminar</a>
						</div>
					</div>
				</article>

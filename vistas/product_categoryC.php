            ...
            <?php
                ...
                if($categorias->rowCount()>0){
                    ...
                    foreach($categorias as $row){
                        echo '<a href="index.php?vista=product_categoryC&category_id='.$row['categoria_id'].'" class="button is-link is-inverted is-fullwidth">'.$row['categoria_nombre'].'</a>';
                    }
                }else{
        ...
        <div class="column">
            <?php
                ...
                if($check_categoria->rowCount()>0){
                    ...
                    $url="index.php?vista=product_categoryC&category_id=$categoria_id&page="; /* <== */
                    $registros=15;
                    $busqueda="";

                    # Paginador producto #
                    require_once "./php/producto_listaC.php";
